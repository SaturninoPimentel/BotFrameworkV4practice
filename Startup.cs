...
namespace Microsoft.PictureBot
{
    ...
    ";
            ...
            services.AddSingleton(sp =>
            {
                LuisApplication luisApp = 
                    new LuisApplication("5125a248-46f9-4031-9c4d-3e7d21255fe5", 
                        "fe43765470a34524abc2535555209a82",
                        "https://southcentralus.api.cognitive.microsoft.com/luis/v2.0/apps/5125a248-46f9-4031-9c4d-3e7d21255fe5?subscription-key=fe43765470a34524abc2535555209a82&verbose=true&timezoneOffset=-360&q=");

                // Specify LUIS options. These may vary for your bot.
                LuisPredictionOptions luisPredictionOptions = new LuisPredictionOptions
                {
                    IncludeAllIntents = true,
                };

                // Create the recognizer
                LuisRecognizer recognizer = new LuisRecognizer(luisApp, luisPredictionOptions, true, null);
                return recognizer;
            });
